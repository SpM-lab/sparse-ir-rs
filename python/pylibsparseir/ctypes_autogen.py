...
FUNCTIONS = {
    ...
    'spir_basis_get_n_default_matsus': ('c_int', ['POINTER(struct spir_basis)', 'c_bool', 'POINTER(c_int)']),
    'spir_basis_get_n_default_matsus_ext': ('c_int', ['POINTER(struct spir_basis)', 'c_bool', 'c_bool', 'c_int', 'POINTER(c_int)']),
    ...
    'spir_matsu_sampling_new': ('POINTER(struct spir_sampling)', ['POINTER(struct spir_basis)', 'c_bool', 'c_int', 'POINTER(c_int64)', 'POINTER(c_int)']),
    'spir_matsu_sampling_new_with_matrix': ('POINTER(struct spir_sampling)', ['c_int', 'c_int', 'c_int', 'c_bool', 'c_int', 'POINTER(c_int64)', 'POINTER(struct Complex64)', 'POINTER(c_int)']),
