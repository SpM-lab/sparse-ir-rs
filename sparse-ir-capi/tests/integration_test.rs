...
use sparse_ir_capi::{
    ...
    spir_basis_get_n_default_taus, spir_basis_get_size, spir_basis_get_svals, spir_basis_get_u,
    ...
    spir_sve_result, spir_sve_result_get_size, spir_sve_result_get_svals, spir_sve_result_new,
